      ...
      <main className={`font-sans text-gray-800 bg-white overflow-x-hidden ${!splashFinished ? 'h-screen overflow-hidden' : ''}`}>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 max-w-7xl mx-auto space-y-16 md:space-y-24" id="about">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center overflow-hidden">
            <motion.div {...fadeInLeft} className="order-2 lg:order-1 space-y-6">
            ...
            <motion.div {...fadeInRight} className="order-1 lg:order-2 relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_10px_40px_rgba(31,38,135,0.15)] transform hover:scale-[1.02] transition-transform duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center overflow-hidden">
            <motion.div {...fadeInLeft} className="order-1 relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_10px_40px_rgba(31,38,135,0.15)] transform hover:scale-[1.02] transition-transform duration-500">
              <Image src="/images/happy_farmer.png" alt="Happy Farmer" fill className="object-cover" />
            </motion.div>
            <motion.div {...fadeInRight} className="order-2 space-y-6">
              <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-primary/10 border-l-4 border-l-primary hover:shadow-lg transition-shadow">
                <h4 className="font-bold text-primary text-xl mb-3 flex items-center gap-3">
                  <span>🎯</span> आमचे ध्येय
                </h4>
                <p className="text-gray-600 text-sm">शेतकऱ्यांना पारदर्शक आणि आधुनिक सेवा देऊन त्यांच्या जीवनमानात सुधारणा घडवून आणणे. उत्कृष्ट दर्जाचे पशुखाद्य पुरवणे आणि योग्य मार्गदर्शन करणे हा आमच्या कार्याचा एक अविभाज्य भाग आहे.</p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-secondary/50 border-l-4 border-l-secondary hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 text-sm">दुग्ध व्यवसायात नाविन्य आणून ग्राहकांना आरोग्यासाठी सर्वोत्तम दूध उत्पादने पुरवणे. बंडगरवाडीतील शेतकऱ्यांची प्रगती हीच आमची खरी ओळख आहे.</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center overflow-hidden">
            <motion.div {...fadeInLeft} className="order-2 lg:order-1 space-y-6">
              <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-blue-100 border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow">
                <h4 className="font-bold text-primary text-xl mb-3 flex items-center gap-3">
                  <span>✅</span> गुणवत्ता हमी
                </h4>
                <p className="text-gray-600 text-sm">आम्ही दुधाच्या प्रत्येक थेंबाची शुद्धता आणि गुणवत्ता तपासतो. ग्राहकांना सकस आणि भेसळमुक्त दूध पुरवणे हीच आमची प्राथमिकता आहे.</p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-orange-100 border-l-4 border-l-orange-500 hover:shadow-lg transition-shadow">
                <h4 className="font-bold text-primary text-xl mb-3 flex items-center gap-3">
                  <span>🤝</span> शेतकऱ्यांचा विश्वास
                </h4>
                <p className="text-gray-600 text-sm">बंडगरवाडीतील शेकडो शेतकरी आमच्यावर विश्वास ठेवतात. पारदर्शक व्यवहार आणि वेळेवर पेमेंट ही आमची ओळख आहे.</p>
              </div>
            </motion.div>
            <motion.div {...fadeInRight} className="order-1 lg:order-2 relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_10px_40px_rgba(31,38,135,0.15)] transform hover:scale-[1.02] transition-transform duration-500">
              <Image src="/images/farmer_milk.png" alt="Farmer with Milk Cans" fill className="object-cover" />
            </motion.div>
          </div>
          ...
          <motion.div {...fadeInView} className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-primary to-[#0a260a] p-8 md:p-12 rounded-3xl shadow-2xl text-white transform hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden flex flex-col items-center justify-center min-h-[320px] md:min-h-[250px]">
              ...
              <div className="absolute top-4 left-4 md:top-6 md:left-6 z-20">
                <Image src="/padalkar_logo-removebg-preview.png" alt="Logo Left" width={80} height={80} className="object-contain drop-shadow-md w-10 h-10 sm:w-16 sm:h-16 md:w-20 md:h-20" />
              </div>
              <div className="absolute top-4 right-4 md:top-6 md:right-6 z-20">
                <Image src="/padalkar_logo-removebg-preview.png" alt="Logo Right" width={80} height={80} className="object-contain drop-shadow-md w-10 h-10 sm:w-16 sm:h-16 md:w-20 md:h-20" />
              </div>
              ...
              <div className="relative z-10 text-center space-y-4 px-4 pt-28 sm:pt-0">
                ...
                <p className="text-white/90 text-base sm:text-lg md:text-xl font-semibold tracking-wide">
                  - आप्पासाहेब पडोळकर
                </p>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 bg-[#f9fff9]" id="services">
          <div className="max-w-7xl mx-auto">
            <motion.div {...fadeInView} className="text-center mb-10 md:mb-16">
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 max-w-7xl mx-auto" id="contact">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <motion.div {...fadeInLeft} className="bg-white/80 backdrop-blur-md p-6 sm:p-8 md:p-10 rounded-2xl shadow-[0_8px_32px_rgba(31,38,135,0.1)] border border-gray-100">
            ...
            <motion.div {...fadeInRight} className="h-[300px] sm:h-[400px] lg:h-auto rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(31,38,135,0.15)] relative">
              <iframe 
        ...
        <footer className="bg-bg-dark text-white pt-16 md:pt-20 pb-8 md:pb-10 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 mb-10 md:mb-12">
            ...
            <motion.div {...fadeInRight} transition={{ delay: 0.4 }}>
